...
with
    ...
    member this.BombLoads =
        ...
        match this with
        | Bf109e7 -> [(1, 200.0f<K>); (2, 250.0f<K>)]
        | Bf109f4 | Bf109f2 | Bf109g2 | Bf109g4-> [(2, 200.0f<K>); (3, 250.0f<K>)]
        ...
        | Ju88a4 -> [(0, 1000.0f<K>); (1, 1500.0f<K>); (3, 2200.0f<K>); (4, 2400.0f<K>); (5, 2900.0f<K>); (6, 2000.0f<K>); (7, 2500.0f<K>); (8, 2900.0f<K>); (9, 2000.0f<K>); (10, 1800.0f<K>); (11, 2800.0f<K>)]
        | Ju52 -> [(1, 2500.0f<K>)]
