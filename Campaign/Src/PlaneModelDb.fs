...
type PlaneModelDto =
    {
        ...
        LastWeaponMod : int option
        LastPayload : int option
...
with
    static member FromJson(json : PlaneModelDto) : PlaneModel =
            ...
            )
        {
            ...
            LastPayload = defaultArg json.LastPayload 128
            LastWeaponMod = defaultArg json.LastWeaponMod 10
        }
    ...
    member this.ToJson() : PlaneModelDto =
...

        {
            ...
            LastWeaponMod = Some this.LastWeaponMod
            LastPayload = Some this.LastPayload
        }
